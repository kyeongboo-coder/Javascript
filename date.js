...
let d = new Date(); // d > Fri Apr 21 2023 17:09:52 GMT+0900 (한국 표준시) // 요일 , 월, 일 , 년 , 시간
...
new Date(2023, 5, 30, 18); // > Fri Jun 30 2023 18:00:00 GMT+0900 (한국 표준시) // 수료일이 6월 30일이니까 Month가 0부터 시작하니까 index값 5로 만들어야 6월을 출력함

// 다음처럼 표현하면 가독성이 훨씬 좋다. 여기에서 문제가 발생! 왜 1이(2월) 아닌가??
new Date("2023/1/20/10:00:00"); // 시간 때문에 그런듯 ?
...
today.getTimezoneOffset() / 60; // 시간대 오프셋을 분단위로 반환 // 오프셋이란? https://hyo-ue4study.tistory.com/56 처음으로 주어진 요소나 지점까지의 변위차를 나타내는 정수형
